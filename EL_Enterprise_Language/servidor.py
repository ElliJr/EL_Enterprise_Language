...
class MyHandler(http.server.BaseHTTPRequestHandler):
    ...
    def processar_cadastro(self, dados):
        ...
        self.send_header("Content-type", "text/plain")
        self.end_headers()
        self.wfile.write(b"Usuário cadastrado com sucesso!\n")
    ...
    def processar_login(self, dados):
        ...
        self.send_error(401, "Usuário ou senha incorretos")
    ...
    def salvar_usuarios(self, usuarios):
        ...
        try:
            ...
            self.send_error(500, "Erro ao salvar dados") # Envia erro para o cliente
