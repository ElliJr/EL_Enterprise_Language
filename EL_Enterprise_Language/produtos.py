...
class Produtos:
    def __init__(self, parent):
        ...
        self.tree_produtos = ttk.Treeview(self.frame, columns=("#1", "#2", "#3", "#4"), show="headings")
        self.tree_produtos.heading("#1", text="Produto")
        self.tree_produtos.heading("#2", text="Categoria")
        self.tree_produtos.heading("#3", text="Preço Venda")
        self.tree_produtos.heading("#4", text="Estoque")
